...
import harriscorner as hc
def test():
    #image = cv2.imread('/Users/timmytimmyliu/research/odometry/test_images/noisy.png')
    image = cv2.imread('C:/Users/User/Downloads/04fig10.jpg')
...
#testgray()
#testMedianBlur()
corners=test()      # corners = fast corners

hcorner=hc.HarrisCornerDetection(corners)
cv2.imshow("harris",hcorner)